(function (Vue, Clipboard) {
  ...
  var parse = function (option) {
    return '<table style="width:100%;background-color:#ffbaba;font-family:\'Microsoft YaHei\',arial,sans-serif">' +
      ...
      '        </p>' +
      '        <p>' +
      '          <a href="' + option.url + '" style="color:#ff3b3b">Web 组第' + option.number + '期周报</a>出炉了~' +
      '        </p>' +
      '        <p>' +
      '          本期热点:' +
      '        </p>' +
      ...
      '        </p>' +
      '        <p>' +
      '          <a href="' + option.url + '" style="display:box;padding:8px 16px;background-color:#e00;color:#eee;text-decoration:none;border-radius:6px">点此阅读</a>' +
      '        </p>' +
      '      </td></tr>' +
      '      <tr><td style="margin:0;padding:12px 8px;background-color:#ffdcdc">' +
      '        <p>' + option.body + '</p>' +
      ...
      '        </p>' +
      '        <p style="margin:0;padding:0">' +
      '          Questions? Email <a href="mailto:web@dongyue.io" style="color:#ff3b3b">web@dongyue.io</a>' +
      '        </p>' +
      '      </td></tr>' +
      '    </table>' +
      '  </td></tr>' +
